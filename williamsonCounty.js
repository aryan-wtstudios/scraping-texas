...
puppeteer
  ...
  .then(async (browser) => {
    ...
    await page.click("#Case");

    await page.type("#CaseSearchValue", "1JC-24-0145");
    ...
    await page.goto(
      `https://judicialrecords.wilco.org/PublicAccess/${caseDetailUrl}`
    );
    ...
    // fs.writeFile("williamson.csv", csvData, (err) => {
    //   if (err) {
